...
var OPTIMIZABLE_IMAGE_TYPES = /* @__PURE__ */ new Set([
  "image/png",
  "image/jpeg",
  "image/webp",
  "image/gif"
]);
async function optimizeProductImage(env, file) {
  ...
  try {
    const result = await env.IMAGES.input(file.stream()).transform({ width: 1600, fit: "scale-down" }).output({ format: "image/webp", quality: 82 });
...
__name(optimizeProductImage, "optimizeProductImage");
...
// .wrangler/tmp/bundle-5OXRgY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-5OXRgY/middleware-loader.entry.ts
